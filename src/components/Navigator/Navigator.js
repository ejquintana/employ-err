          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav mr-auto">
              <li className="nav-item active">
               <strong> <a className="nav-link" style={{color:"#EE5F46" }} href="/employee">Employee Login</a></strong>
              </li>
              <li className="nav-item active">
                <strong><a className="nav-link" style={{color:"#EE5F46" }} href="/employer">Employer Login</a></strong>
              </li>
            </ul>
